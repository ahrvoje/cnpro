...
## 8. Communication and Development Style

### Tone & Language

Use ASD-STE100 (Simplified Technical English).

Follow Zinsser's principles: simplicity, brevity, clarity, humanity.
...
Make structural guarantees ensuring defined contracts can not be broken.

This is especially relevant when code accuracy and reliability depends on precise agreement between multiple disjoint elements with non-local or weak dependencies or descriptive alignment.

Make it structurally impossible for localized code changes to accidentally break the contract made between multiple elements or interfaces.

### Third-party Verification

Your work will be independently verified by other vendors' top-tier AI models.
